class User < ActiveRecord::Base
  ...
  def unhave(other_item)
    have = haves.find_by(item_id: other_item.id)
  ...
  def want(other_item)
    wants.find_or_create_by(item_id: other_item.id)
  end

  def unwant(other_item)
    want = wants.find_by(item_id: other_item.id)
